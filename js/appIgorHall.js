...
// EASTER EGG TRACKER
// ============================
const EGG_IDS=["konami","dragonage","baldur","reddead","fallout","metalgear","witcher","onepiece"];
const EGG_TOTAL=EGG_IDS.length;
...
const assistantKnowledge = [
    ...
    // UNITY
    {priority:180,keywords:["unity","igorunity","videojuego unity","desarrollar videojuego","unity hub"],answer:"IGORUNITY: 82 temas en 7 niveles, 91 assets, 10+ vídeos. Del editor y C# hasta multiplayer, VR y publicación en tiendas. → igorhermoso1.github.io/IGORUNITY"},
